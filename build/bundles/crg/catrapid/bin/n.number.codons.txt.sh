...
if(aminoacid[i]=="A"){c=0.6};
if(aminoacid[i]=="C"){c=0};
if(aminoacid[i]=="D"){c=0.2};
if(aminoacid[i]=="E"){c=0.2};
if(aminoacid[i]=="F"){c=0.2};
if(aminoacid[i]=="G"){c=0.6};
if(aminoacid[i]=="H"){c=0.2};
if(aminoacid[i]=="I"){c=0.4};
if(aminoacid[i]=="K"){c=0.2};
if(aminoacid[i]=="L"){c=1};
if(aminoacid[i]=="M"){c=0};
if(aminoacid[i]=="N"){c=0.2};
if(aminoacid[i]=="P"){c=0.6};
if(aminoacid[i]=="Q"){c=0.2};
if(aminoacid[i]=="R"){c=1};
if(aminoacid[i]=="S"){c=1};
if(aminoacid[i]=="T"){c=0.6};
if(aminoacid[i]=="V"){c=0.6};
if(aminoacid[i]=="W"){c=0};
if(aminoacid[i]=="Y"){c=0.2};
if(aminoacid[i]=="X"){c='0.4'}
