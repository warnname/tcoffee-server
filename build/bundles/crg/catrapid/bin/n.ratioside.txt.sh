...
if(aminoacid[i]=="D"){c=0.501818};
if(aminoacid[i]=="E"){c=0.334545};
if(aminoacid[i]=="F"){c=0};
if(aminoacid[i]=="G"){c=0.269091};
if(aminoacid[i]=="H"){c=0.210909};
if(aminoacid[i]=="I"){c=0};
if(aminoacid[i]=="K"){c=0.12};
if(aminoacid[i]=="L"){c=0};
if(aminoacid[i]=="M"){c=0};
if(aminoacid[i]=="N"){c=0.483636};
if(aminoacid[i]=="P"){c=0.141818};
if(aminoacid[i]=="Q"){c=0.323636};
if(aminoacid[i]=="R"){c=0.236364};
if(aminoacid[i]=="S"){c=0.516364};
if(aminoacid[i]=="T"){c=0.258182};
if(aminoacid[i]=="V"){c=0};
if(aminoacid[i]=="W"){c=0.0472727};
if(aminoacid[i]=="Y"){c=0.0727273};
if(aminoacid[i]=="X"){c='0.225818'}
