...
print P '$SCRIPTSDIR/sim2matrix.pl -query $QUERYFILE  -experiment $EXPERIMENT -pipeline_dir $PIPELINEDIR > $PIPELINEDIR/experiments/$EXPERIMENT/simMatrix.csv' . "\n";
...
sub prepareDir {
  ...
  print ESF 'for SCRIPT in `ls script*`; do qsub -cwd -o $PWD -e $PWD $SCRIPT ; done' . "\n";
  print ESF 'cd ..' . "\n";
  print ESF 'done'  . "\n";
  ...
  print CC "#COMMAND\n";
  print CC "qsub -V -o /dev/null -e ${pipelineOutDir}/CLUSTER_FILES -r y -cwd  ##SCRIPT##";
  print CC "\n\n#HEADER\n";
