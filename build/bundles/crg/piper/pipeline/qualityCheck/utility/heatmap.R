options(expressions=20000) #this option is needed if you have many features in your matrix and you have to tell R that it is not an infinite loop, but just a bit longer
...
png("heatMap.png", width=1000, height=1000, antialias="default")  #if you have too many features you might have withe stripes in the figure. to avoid this either choose the pdf as output,
...
x <- heatmap.2(testMat, Colv=rev.dend.col ,col=colorpanel(40, "red", "black", "green"),scale="none",key=TRUE,keysize=0.7,symkey=FALSE,density.info="none",trace="none",cexRow=0.5,cexCol=1.1 )
